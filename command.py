...
def create_admin(email, name):
    ...
    # WARNING: Password is stored as plain text! Replace with hash in production.
    engine = create_engine("postgresql+psycopg2://postgres:123456@localhost:5432/madcrow")
